...
SAVE_INTERVAL = 500
EVAL_INTERVAL = 100
VAL_DATASET_PATH = "/home/adam/datasets/fineweb-edu-val-4096"  # Added as a constant


def main():
    parser = argparse.ArgumentParser(description="Train Mamba-2 Baseline on Trillium (Europe)")
